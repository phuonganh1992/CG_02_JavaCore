...
public class CopyDirectory {
    static String SOURCE_PATH_FILE = "C:\\Users\\Admin\\Desktop\\parent\\SOURCEFILE";
    static String DEST_PATH_FILE = "C:\\Users\\Admin\\Desktop\\parent\\DESTFILE";

    public static void main(String[] args) throws IOException {
        File sourceFile = new File(SOURCE_PATH_FILE);
        File destFile = new File(DEST_PATH_FILE);
